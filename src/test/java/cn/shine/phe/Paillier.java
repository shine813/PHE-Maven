...
import cn.shine.phe.Util.NotImplementedErrorException;
import cn.shine.phe.Util.TypeErrorException;
import cn.shine.phe.Util.ValueErrorException;
...
public class Paillier {
    ...
    public static class PaillierKeyPair {
         ...
         */
        public static @NotNull PaillierKeyPair generate(Integer nLength) throws ValueErrorException {
            if (nLength == 0) {
                throw new ValueErrorException("key length should not be zero");
            }
    ...
    public static class PaillierPrivateKey {
         ...
         * @throws ValueErrorException if the public key and the private key is not match, or p is equal q
         */
        public PaillierPrivateKey(@NotNull PaillierPublicKey publicKey, @NotNull BigInteger p, BigInteger q)
            ...
            if (!p.multiply(q).equals(publicKey.n)) {
                throw new ValueErrorException("given public key does not match the given p and q");
            }

            if (p.equals(q)) {
                throw new ValueErrorException("p and q have to be different");
            }
         ...
         * @throws ValueErrorException if p * q != publicKey.n
         */
        public PaillierPrivateKey fromTotient(@NotNull PaillierPublicKey publicKey, BigInteger totient)
            ...
            if (!p.multiply(q).equals(publicKey.n)) {
                throw new ValueErrorException("given public key and totient do not match");
            }
         ...
         * @throws ValueErrorException if public keys are not match
         */
        public @NotNull EncodedNumber decryptEncoded(@NotNull EncryptedNumber encryptedNumber)
            ...
            if (this.publicKey != encryptedNumber.publicKey) {
                throw new ValueErrorException("encrypted_number was encrypted against a different key");
            }
    ...
    public static class EncryptedNumber {
         ...
         * @throws ValueErrorException if public key is not match
         */
        public EncryptedNumber add(Object other) throws ValueErrorException {
         ...
         * @return EncryptedNumber this * other
         * @throws NotImplementedErrorException if other is EncryptedNumber
         */
        public EncryptedNumber multiply(Object other) throws NotImplementedErrorException {
            EncodedNumber encoding;

            if (other instanceof EncryptedNumber) {
                throw new NotImplementedErrorException("good luck with that...");
            } else if (other instanceof EncodedNumber) {
         ...
         * @throws ValueErrorException if public key is not match
         */
        public EncryptedNumber subtract(Object other) throws ValueErrorException {
            if (other instanceof EncryptedNumber) {
         ...
         * @return EncryptedNumber this / other
         * @throws NotImplementedErrorException should not be EncryptedNumber
         * @throws TypeErrorException           should not be EncodedNumber
         */
        public EncryptedNumber divide(Object other) throws NotImplementedErrorException, TypeErrorException {
            if (other instanceof EncryptedNumber) {
                throw new NotImplementedErrorException("good luck with that...");
            } else if (other instanceof EncodedNumber) {
                throw new TypeErrorException("should not be EncodedNumber");
            } else {
                other = Util.wrapBig(other);
                if (other instanceof BigInteger) {
         ...
         * @return EncryptedNumber
         * @throws ValueErrorException if newExp > this.exponent
         */
        public EncryptedNumber decreaseExponentTo(@NotNull BigInteger newExp) throws ValueErrorException {
            if (newExp.compareTo(this.exponent) > 0) {
                String exception = "New exponent %s should be more negative than old exponent %s";
                throw new ValueErrorException(String.format(exception, newExp, this.exponent));
            }
         ...
         * @throws ValueErrorException if public key is not match
         */
        private @NotNull EncryptedNumber addScalar(Object scalar) throws ValueErrorException {
         ...
         * @throws ValueErrorException if public key is not match
         */
        private @NotNull EncryptedNumber addEncoded(@NotNull EncodedNumber encoded) throws ValueErrorException {
            if (this.publicKey != encoded.publicKey) {
                throw new ValueErrorException("Attempted to add numbers encoded against different public keys");
            }
         ...
         * @throws ValueErrorException if public key is not match
         */
        private @NotNull EncryptedNumber addEncrypted(@NotNull EncryptedNumber other) throws ValueErrorException {
        ...
        private @NotNull BigInteger rawMul(@NotNull BigInteger plaintext) {
            if (plaintext.compareTo(BigInteger.ZERO) < 0 || plaintext.compareTo(this.publicKey.n) >= 0) {
                throw new ValueErrorException(String.format("Scalar out of bounds: %s", plaintext));
            }
